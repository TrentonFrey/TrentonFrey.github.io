...
//
// Main code functionality is as follows.
// This code utilizes OpenGL to build a 3D scene with texutre and camera movment.
// With the changes made for cs499 you can now load external object files to build scene.
// Implimented the code from 05/04 milestone project and lighting method.
// I used the stb_imgage header file and the camera header file from project milestone 06.
// Trenton Frey enhancments for cs499 9/15/22. 
// Added multi texture support.
// Implmented a object loader libary and header file.
// Enhanced commenting standards throughout code.
// Known issues.
// May encounter libary issues when building on a different system.
// May encounter file path issues when building on a different system.
//
...
#include <vector>
#include "objloader.hpp"// object loader file
#include <string>
...
namespace
{
    ...
    const char* const WINDOW_TITLE = "TrentonFrey_final"; // Macro for window title
    ...
    struct GLMesh
    {
        ...
        GLuint vbo; 
        GLuint uvBuffer;        // Handle for the vertex buffer object
        GLuint nVertices;
        GLuint normalBuffer;// Number of indices of the mesh
        GLuint texture;
    ...
    // camera settings
    Camera gCamera(glm::vec3(0.0f, -12.0f, 15.0f));
    ...
    glm::vec3 gObjectColor(0.0f, 1.0f, 0.0f);
    glm::vec3 gLightColor(1.0f, 1.0f, 1.0f);

    // Light position and scale
    glm::vec3 gLightPosition(1.0f, 0.5f, 20.0f);
    glm::vec3 gLightScale(0.9f);
}
...
int main(int argc, char* argv[])
{
    ...
    //
    // Adding more than one texture into the space. 
    // Loading the texture into the program.
    // Check if file exists.
    const char* texFilename = "/school/OpenGLSample/resources/textures/Steel.png";
    ...
    //Pass in another textuer into texture id array
    texFilename = "/school/OpenGLSample/resources/textures/carbon3.png";
