//This is an automated test for every function of a task section of the program.
//Creates a vaild test for create,id,name,description,update,deleteTask and add
