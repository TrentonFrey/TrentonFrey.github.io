...
//
//I used the implimented the code from 05_04.and lighting
//I used pulled the stb_imgage header file and reused the camera header file from the last project
//Trenton Frey 4/15/22 
//used some texturieng code from last project then implimented the lighting into this
//This became more difficult than I tought it was
//Im not sure how to add more than one texture
...
int main(int argc, char* argv[])
{
    ...
    const char* texFilename = "/school/OpenGLSample/resources/textures/carbon3.png";
